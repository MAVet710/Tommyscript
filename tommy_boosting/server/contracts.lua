...
local function mkContract(identifier, class)
    ...
    return {
        ...
        tracker_removed = 0, expires_at = os.date('%Y-%m-%d %H:%M:%S', os.time() + Config.ContractExpireMinutes * 60), zone = zone, drop = drop
    }
end
